import type { AugmentPlugin } from './types.js';

const ARCHIFY_INSTRUCTIONS = `## 🎨 架构图绘制（Archify）
...
export const ARCHIFY_RUNTIME_DIR = 'archify';

export const archifyPlugin: AugmentPlugin = {
  id: 'archify',
  name: 'Archify Diagrams',
  type: 'augment',
  version: '2.13.0',
  targetSkills: ['sparrow-arch', 'sparrow-model', 'sparrow-design'],
  skillContent: ARCHIFY_INSTRUCTIONS,
};
